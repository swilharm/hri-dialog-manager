...
class DialogManagerModule(AbstractModule):
    ...
    def __init__(self, **kwargs):
        ...
        self.language = {'confidence_instruction': 0.0, 'coordinates': dict(), 'flag': 0, 'time': time.time()}
    ...
    def process_update(self, update_message):
        ...
        if input_iu.type() == "Language and Vision IU":
            ...
            self.language['flag'] = input_iu.flag
        ...
        if self.language['confidence_instruction'] > instr_thresh:
            ...
            output_iu.flag = self.language['flag']
        ...
        print(output_iu.confidence_decision, output_iu.decision_coordinate, output_iu.flag)
